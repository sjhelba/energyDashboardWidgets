define(['bajaux/Widget', 'bajaux/mixin/subscriberMixIn', 'nmodule/ceoWeb/rc/d3/d3.min', 'css!nmodule/tekScratch/rc/web/ModernEfficiencyGraph/style'], function (Widget, subscriberMixIn, d3) {
	"use strict";
	...
	const setupDefinitions = widget => {
		...
		return widget.resolve(`history:^System_MsEffMr`)
			...
			.then(() => widget.resolve(`history:^System_MsEffCurrentMonth`))
			.then(measuredTable => {
				let lastRowValue = 0;
