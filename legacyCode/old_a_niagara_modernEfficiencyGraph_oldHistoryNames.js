define(['bajaux/Widget', 'bajaux/mixin/subscriberMixIn', 'nmodule/tekScratch/rc/d3/d3.min', 'css!nmodule/tekScratch/rc/web/ModernEfficiencyGraph/style'], function (Widget, subscriberMixIn, d3) {
  ...
  const setupDefinitions = widget => {
      ...
      // GET HISTORY DATA //
      return widget.resolve(`history:^${data.systemName}_MsEff`)
          .then(measuredTable => {
          ...
          .then(() => widget.resolve(`history:^${data.systemName}_BlEff`)) 
          ...
          .then(() => widget.resolve(`history:^${data.systemName}_PrEff`)) 
