...
////////////////////////////////////////////////////////////////
	...
	EfficiencyMap.prototype = Object.create(Widget.prototype);
	EfficiencyMap.prototype.constructor = EfficiencyMap;
...
////////////////////////////////////////////////////////////////
	...
	const setupDefinitions = widget => {
		...
		return Promise.all([widget.resolve(`history:^System_WbtHr`), widget.resolve(`history:^System_MsEffHr`)])
			...
			.catch(err => console.error('Error for efficiencyMap (history calculations promise rejected): ' + err));
	};
...
////////////////////////////////////////////////////////////////
	...
	EfficiencyMap.prototype.doInitialize = function(element) {
		var that = this;
		element.addClass("EfficiencyMapOuter");
...
////////////////////////////////////////////////////////////////
	...
	EfficiencyMap.prototype.doLayout = EfficiencyMap.prototype.doChanged = EfficiencyMap.prototype.doLoad = function() {
		render(this);
	};

	/* FOR FUTURE NOTE: 
	EfficiencyMap.prototype.doChanged = function (name, value) {
		  if(name === "value") valueChanged += 'prototypeMethod - ';
		  render(this);
	};
	*/

	EfficiencyMap.prototype.doDestroy = function() {
		this.jq().removeClass("EfficiencyMapOuter");
	};
